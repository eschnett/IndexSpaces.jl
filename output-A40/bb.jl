@inbounds begin #= /home/eschnett/src/jl/IndexSpaces/kernels/bb.jl:809 =#
    info = 1
    info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 512) % 512) * 768 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32) + 0 + 0x01] =
        info
    s = s_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) ÷ 16) % 2) % 2) * 96 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) ÷ 32) % 16) % 16) * 192 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96) + 0x01]
    s = s - 3
    if !(0i32 < s < 32i32)
        info = 2
        info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 512) % 512) * 768 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32) + 0 + 0x01] =
    ...
    for T1 in 0:128:2047
        ...
        for T2 in 0:32:127
            if IndexSpaces.cuda_warpidx() < 16
                        ...
                        (
                            (
                                (
                                    (
                                        (
                                            (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + 16) +
                                            ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32
                                        ) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4
                                    ) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048
                                ) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128
                ...
                E_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] =
                    E_dish0_time0
                E_shared[((((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] =
                    E_dish4_time0
                E_shared[((((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] =
                    E_dish8_time0
                E_shared[((((12 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] =
                    E_dish12_time0
                E_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + 16) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] =
                    E_dish0_time16
                E_shared[((((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + 16) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] =
                    E_dish4_time16
                E_shared[((((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + 16) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] =
                    E_dish8_time16
                E_shared[((((12 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + 16) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0 + 0x01] =
                    E_dish12_time16
            end
            ...
            for T3 in 0:8:31
                let
                    ...
                    let
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[((((((D ÷ 4) % 8) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 32) ÷ 4) % 128 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 129) + 0x01]
                    ...
                    Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + ((B ÷ 8) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200 + (((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0 + 0x01] =
                        Ju_time0
                    Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + ((B ÷ 8) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200 + ((((((1 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0 + 0x01] =
                        Ju_time1
                end
                let
                    B = 8
            ...
            IndexSpaces.cuda_sync_threads()
            Ju_dish0_time0 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 0 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish128_time0 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 3200 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish256_time0 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 6400 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish384_time0 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 9600 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish0_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 0 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish128_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 3200 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish256_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 6400 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish384_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 9600 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish0_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 0 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish128_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 3200 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish256_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 6400 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish384_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 9600 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish0_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 0 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 24) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish128_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 3200 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 24) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish256_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 6400 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 24) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
            Ju_dish384_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + 9600 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 24) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 512) % 16) * 2048) + ((IndexSpaces.assume_inrange(T1, 0, 128, 2048) ÷ 128) % 16) * 128) % 32) * 100) + 0x01]
