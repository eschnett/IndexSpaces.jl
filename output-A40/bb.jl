@inbounds begin #= /home/eschnett/src/jl/IndexSpaces/kernels/bb.jl:794 =#
    info = 1
    ...
    (A_beam8_cplx0_dish0, A_beam8_cplx1_dish0, A_beam8_cplx0_dish4, A_beam8_cplx1_dish4) = IndexSpaces.unsafe_load4_global(
        ...
        (
            ...
            (
                (
                    (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + 8) +
                    ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2
                ) % 96
            ) * 256
        ) + 1i32,
    ...
    (A_beam0_cplx0_dish16, A_beam0_cplx1_dish16, A_beam0_cplx0_dish20, A_beam0_cplx1_dish20) = IndexSpaces.unsafe_load4_global(
        ...
        (
            ...
            (
                (
                    (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + 1) +
                    ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2
                ) % 96
            ) * 256
        ) + 1i32,
    ...
    (A_beam8_cplx0_dish16, A_beam8_cplx1_dish16, A_beam8_cplx0_dish20, A_beam8_cplx1_dish20) = IndexSpaces.unsafe_load4_global(
        ...
        (
            ...
            (
                (
                    ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + 1) + 8) +
                    ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2
                ) % 96
            ) * 256
        ) + 1i32,
    ...
    for T1 in 0:128:16383
        ...
        for T2 in 0:32:127
                            ...
                            (
                                (
                                    (
                                        ...
                                        ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128
            ...
            for T3 in 0:8:31
                let
                    ...
                    let
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 32 + ((D ÷ 4) % 8) * 4) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8 + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 129) + 0x01]
                    ...
                    Ju_shared[((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2 + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + ((B ÷ 8) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0 + 0x01] =
                        Ju_time0
                    Ju_shared[((((((1 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + ((B ÷ 8) % 2) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0 + 0x01] =
                        Ju_time1
                end
                let
                    B = 8
            ...
            IndexSpaces.cuda_sync_threads()
            Ju_dish0_time0 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 0) + 0x01]
            Ju_dish128_time0 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + 0x01]
            Ju_dish256_time0 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + 0x01]
            Ju_dish384_time0 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + 0x01]
            Ju_dish0_time8 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 0) + 0x01]
            Ju_dish128_time8 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + 0x01]
            Ju_dish256_time8 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + 0x01]
            Ju_dish384_time8 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + 0x01]
            Ju_dish0_time16 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 0) + 0x01]
            Ju_dish128_time16 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + 0x01]
            Ju_dish256_time16 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + 0x01]
            Ju_dish384_time16 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + 0x01]
            Ju_dish0_time24 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 0) + 0x01]
            Ju_dish128_time24 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + 0x01]
            Ju_dish256_time24 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + 0x01]
            Ju_dish384_time24 = Ju_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8 + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 16384) ÷ 128) % 128) * 128) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + 0x01]
        ...
        IndexSpaces.unsafe_store4_global!(
            J_memory,
            (
                ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 4096 +
                (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 8192 +
                (
                    (
                        (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 +
