@inbounds begin #= /home/eschnett/src/jl/IndexSpaces/kernels/bb.jl:801 =#
    info = 1
    info_memory[((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 32) % 32) * 768) + 0 + 0x01] =
        info
    ...
    (A_beam8_cplx0_dish0, A_beam8_cplx1_dish0, A_beam8_cplx0_dish4, A_beam8_cplx1_dish4) = IndexSpaces.unsafe_load4_global(
        ...
        (
            ...
            (
                (
                    (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2 + 8) +
                    ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16
                ) % 96
            ) * 256 +
            ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 24576 +
    ...
    (A_beam0_cplx0_dish16, A_beam0_cplx1_dish16, A_beam0_cplx0_dish20, A_beam0_cplx1_dish20) = IndexSpaces.unsafe_load4_global(
        ...
        (
            ...
            (
                (
                    (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2 + 1) +
                    ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16
                ) % 96
            ) * 256 +
            ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 24576 +
    ...
    (A_beam8_cplx0_dish16, A_beam8_cplx1_dish16, A_beam8_cplx0_dish20, A_beam8_cplx1_dish20) = IndexSpaces.unsafe_load4_global(
        ...
        (
            ...
            (
                (
                    ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2 + 1) + 8) +
                    ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16
                ) % 96
            ) * 256 +
            ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 24576 +
    ...
    for T1 in 0:128:32767
        ...
        for T2 in 0:32:127
            if IndexSpaces.cuda_warpidx() < 16
                (E_dish0_time0, E_dish4_time0, E_dish8_time0, E_dish12_time0) = IndexSpaces.unsafe_load4_global(
                    ...
                    (
                        ...
                        (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 128
                    ) + 1i32,
                )
                    ...
                    (
                        ...
                        (
                            (
                                (
                                    (
                                        (16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) +
                                        ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32
                                    ) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128
                                ) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4
                            ) % 32768
                ...
                E_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129) + 0 + 0x01] =
                    E_dish0_time0
                E_shared[((((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129) + 0 + 0x01] =
                    E_dish4_time0
                E_shared[((((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129) + 0 + 0x01] =
                    E_dish8_time0
                E_shared[((((12 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129) + 0 + 0x01] =
                    E_dish12_time0
                E_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129) + 0 + 0x01] =
                    E_dish0_time16
                E_shared[((((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129) + 0 + 0x01] =
                    E_dish4_time16
                E_shared[((((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129) + 0 + 0x01] =
                    E_dish8_time16
                E_shared[((((12 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + (((((16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) % 32) * 129) + 0 + 0x01] =
                    E_dish12_time16
            end
            ...
            for T3 in 0:8:31
                let
                    ...
                    let
                        ...
                        Are = AselBD_cplx0
                        Aim = AselBD_cplx1
                        E0 = E_shared[((((((D ÷ 4) % 8) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128 + ((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 32) * 129) + 0x01]
                    ...
                    Ju_shared[(((((B ÷ 8) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) % 96 + ((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) % 32) * 100 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0 + 0x01] =
                        Ju_time0
                    Ju_shared[(((((B ÷ 8) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) % 96 + (((((((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + 1) % 32) * 100 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0 + 0x01] =
                        Ju_time1
                end
                let
                    B = 8
            ...
            IndexSpaces.cuda_sync_threads()
            Ju_dish0_time0 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + (((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 0) + 0x01]
            ...
            Ju_dish0_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 0) + 0x01]
            Ju_dish128_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 3200) + 0x01]
            Ju_dish256_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 6400) + 0x01]
            Ju_dish384_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((8 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 9600) + 0x01]
            Ju_dish0_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((16 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 0) + 0x01]
            Ju_dish128_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((16 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 3200) + 0x01]
            Ju_dish256_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((16 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 6400) + 0x01]
            Ju_dish384_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((16 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 9600) + 0x01]
            Ju_dish0_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((24 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 0) + 0x01]
            Ju_dish128_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((24 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 3200) + 0x01]
            Ju_dish256_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((24 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 6400) + 0x01]
            Ju_dish384_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96 + ((((24 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) % 32) * 100 + 9600) + 0x01]
        ...
        IndexSpaces.unsafe_store4_global!(
            ...
            (
                ...
                ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 8192 +
