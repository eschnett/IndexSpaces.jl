...
cudaBasebandBeamformer::cudaBasebandBeamformer(Config& config,
...
cudaEvent_t cudaBasebandBeamformer::execute(cudaPipelineState& pipestate,
    ...
    INFO("input A array: {:s} {:s}",
        meta_A->get_type_string(),
        meta_A->get_dimensions_string());
    ...
    INFO("output J array: {:s} {:s}",
        meta_J->get_type_string(),
        meta_J->get_dimensions_string());
