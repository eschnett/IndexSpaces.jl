@inbounds begin #= /home/eschnett/src/jl/IndexSpaces/kernels/bb.jl:754 =#
    info = 1
        ...
        (
            (
                (
                    (
                        (
                            ((8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) + 1) +
                            ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2
                        ) % 96
                    ) * 256 +
                    (
