#= /home/eschnett/src/jl/IndexSpaces/kernels/bb.jl:754 =# @inbounds begin
        info = 1
        info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 32) % 32) * 768) + 0 + 0x01] = info
        s = s_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 96) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 192) + 0x01]
        s = s - 3
        if !(0 < s < 32)
            info = 2
            info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 32) % 32) * 768) + 0 + 0x01] = info
        ...
        (A_beam0_cplx0_dish0, A_beam0_cplx1_dish0, A_beam0_cplx0_dish4, A_beam0_cplx1_dish4) = IndexSpaces.unsafe_load4_global(A_memory, (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2) % 96) * 256 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 2) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 2) * 32) ÷ 2) % 256) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 24576) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 49152) + 1i32)
        (A_beam8_cplx0_dish0, A_beam8_cplx1_dish0, A_beam8_cplx0_dish4, A_beam8_cplx1_dish4) = IndexSpaces.unsafe_load4_global(A_memory, ((((((8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2) % 96) * 256 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 2) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 2) * 32) ÷ 2) % 256) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 24576) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 49152) + 1i32)
        (A_beam0_cplx0_dish8, A_beam0_cplx1_dish8, A_beam0_cplx0_dish12, A_beam0_cplx1_dish12) = IndexSpaces.unsafe_load4_global(A_memory, (((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2) % 96) * 256 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 2) % 4) * 8) + 64) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 2) * 32) ÷ 2) % 256) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 24576) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 49152) + 1i32)
        (A_beam8_cplx0_dish8, A_beam8_cplx1_dish8, A_beam8_cplx0_dish12, A_beam8_cplx1_dish12) = IndexSpaces.unsafe_load4_global(A_memory, ((((((8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2) % 96) * 256 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 2) % 4) * 8) + 64) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 2) * 32) ÷ 2) % 256) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 24576) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 49152) + 1i32)
        (A_beam0_cplx0_dish16, A_beam0_cplx1_dish16, A_beam0_cplx0_dish20, A_beam0_cplx1_dish20) = IndexSpaces.unsafe_load4_global(A_memory, ((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16 + 1) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2) % 96) * 256 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 2) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 2) * 32) ÷ 2) % 256) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 24576) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 49152) + 1i32)
        (A_beam8_cplx0_dish16, A_beam8_cplx1_dish16, A_beam8_cplx0_dish20, A_beam8_cplx1_dish20) = IndexSpaces.unsafe_load4_global(A_memory, (((((((8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) + 1) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2) % 96) * 256 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 2) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 2) * 32) ÷ 2) % 256) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 24576) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 49152) + 1i32)
        ...
        for T1 = 0:128:32767
            ...
            for T2 = 0:32:127
                if IndexSpaces.cuda_warpidx() < 16
                    (E_dish0_time0, E_dish4_time0, E_dish8_time0, E_dish12_time0) = IndexSpaces.unsafe_load4_global(E_memory, (((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 32768) * 4096 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) ÷ 4) % 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 2048) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 128) + 1i32)
                    (E_dish0_time16, E_dish4_time16, E_dish8_time16, E_dish12_time16) = IndexSpaces.unsafe_load4_global(E_memory, ((((((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 32768) * 4096 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) ÷ 4) % 128) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 2048) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 128) + 1i32)
                    E_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) ÷ 4) % 128 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 32) * 129) + 0 + 0x01] = E_dish0_time0
                    E_shared[((((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) ÷ 4) % 128 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 32) * 129) + 0 + 0x01] = E_dish4_time0
                    E_shared[((((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) ÷ 4) % 128 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 32) * 129) + 0 + 0x01] = E_dish8_time0
                    E_shared[((((12 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) ÷ 4) % 128 + ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 32) * 129) + 0 + 0x01] = E_dish12_time0
                ...
                for T3 = 0:8:31
                    let
                        ...
                        let
                            ...
                            Aim = AselBD_cplx0
                            Are = AselBD_cplx1
                            E0 = E_shared[(((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) + ((IndexSpaces.assume_inrange(D, 0, 4, 32) ÷ 4) % 8) * 4) ÷ 4) % 128 + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129) + 0x01]
                        ...
                        Ju_shared[((((((IndexSpaces.assume_inrange(B, 0, 8, 16) ÷ 8) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2 + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0 + 0x01] = Ju_time0
                        Ju_shared[((((((IndexSpaces.assume_inrange(B, 0, 8, 16) ÷ 8) % 2) * 8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) % 96 + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + (((((1 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + ((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0 + 0x01] = Ju_time1
                    end
                    let
                        B = 8
                        AselB_cplx0_dish0 = zero(Int8x4)
                ...
                IndexSpaces.cuda_sync_threads()
                Ju_dish0_time0 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + (((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish128_time0 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + (((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish256_time0 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + (((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish384_time0 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + (((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish0_time8 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish128_time8 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish256_time8 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish384_time8 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish0_time16 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish128_time16 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish256_time16 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish384_time16 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish0_time24 = Ju_shared[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish128_time24 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 3200) + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish256_time24 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 6400) + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
                Ju_dish384_time24 = Ju_shared[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96 + 9600) + ((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + 24) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100) + 0x01]
            ...
            IndexSpaces.unsafe_store4_global!(J_memory, ((((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4) % 96) * 262144 + (((((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 2) * 16 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 2) * 32) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 2) % 2) * 64) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) ÷ 4) % 8192) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 8192) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 16384) + 0 + 0x01, (Jper_time0, Jper_time32, Jper_time64, Jper_time96))
        end
        info = 0
        info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 32) % 32) * 768) + 0 + 0x01] = info
    end
