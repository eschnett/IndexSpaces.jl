#= /home/eschnett/src/jl/IndexSpaces/kernels/bb.jl:534 =# @inbounds begin
        s = s_memory[((((IndexSpaces.cuda_threadidx() ÷ 8) % 4 + (IndexSpaces.cuda_warpidx() % 32) * 4) % 128 + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 256) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 128) + 0x01]
        (A_beam0_cplx0_dish0, A_beam0_cplx1_dish0, A_beam0_cplx0_dish4, A_beam0_cplx1_dish4) = IndexSpaces.unsafe_load4_global(A_memory, (((((((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 16 + ((IndexSpaces.cuda_threadidx() ÷ 8) % 4) * 2) % 128) * 256 + ((((IndexSpaces.cuda_threadidx() % 2) * 32 + ((IndexSpaces.cuda_threadidx() ÷ 2) % 4) * 8) + (IndexSpaces.cuda_warpidx() % 4) * 128) ÷ 2) % 256) + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 65536) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 32768) + 1i32)
        (A_beam8_cplx0_dish0, A_beam8_cplx1_dish0, A_beam8_cplx0_dish4, A_beam8_cplx1_dish4) = IndexSpaces.unsafe_load4_global(A_memory, ((((((((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 16 + 8) + ((IndexSpaces.cuda_threadidx() ÷ 8) % 4) * 2) % 128) * 256 + ((((IndexSpaces.cuda_threadidx() % 2) * 32 + ((IndexSpaces.cuda_threadidx() ÷ 2) % 4) * 8) + (IndexSpaces.cuda_warpidx() % 4) * 128) ÷ 2) % 256) + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 65536) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 32768) + 1i32)
        (A_beam0_cplx0_dish8, A_beam0_cplx1_dish8, A_beam0_cplx0_dish12, A_beam0_cplx1_dish12) = IndexSpaces.unsafe_load4_global(A_memory, (((((((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 16 + ((IndexSpaces.cuda_threadidx() ÷ 8) % 4) * 2) % 128) * 256 + (((((IndexSpaces.cuda_threadidx() % 2) * 32 + ((IndexSpaces.cuda_threadidx() ÷ 2) % 4) * 8) + (IndexSpaces.cuda_warpidx() % 4) * 128) + 64) ÷ 2) % 256) + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 65536) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 32768) + 1i32)
        (A_beam8_cplx0_dish8, A_beam8_cplx1_dish8, A_beam8_cplx0_dish12, A_beam8_cplx1_dish12) = IndexSpaces.unsafe_load4_global(A_memory, ((((((((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 16 + 8) + ((IndexSpaces.cuda_threadidx() ÷ 8) % 4) * 2) % 128) * 256 + (((((IndexSpaces.cuda_threadidx() % 2) * 32 + ((IndexSpaces.cuda_threadidx() ÷ 2) % 4) * 8) + (IndexSpaces.cuda_warpidx() % 4) * 128) + 64) ÷ 2) % 256) + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 65536) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 32768) + 1i32)
        (A_beam0_cplx0_dish16, A_beam0_cplx1_dish16, A_beam0_cplx0_dish20, A_beam0_cplx1_dish20) = IndexSpaces.unsafe_load4_global(A_memory, ((((((((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 16 + ((IndexSpaces.cuda_threadidx() ÷ 8) % 4) * 2) + 1) % 128) * 256 + ((((IndexSpaces.cuda_threadidx() % 2) * 32 + ((IndexSpaces.cuda_threadidx() ÷ 2) % 4) * 8) + (IndexSpaces.cuda_warpidx() % 4) * 128) ÷ 2) % 256) + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 65536) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 32768) + 1i32)
        (A_beam8_cplx0_dish16, A_beam8_cplx1_dish16, A_beam8_cplx0_dish20, A_beam8_cplx1_dish20) = IndexSpaces.unsafe_load4_global(A_memory, (((((((((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 16 + 8) + ((IndexSpaces.cuda_threadidx() ÷ 8) % 4) * 2) + 1) % 128) * 256 + ((((IndexSpaces.cuda_threadidx() % 2) * 32 + ((IndexSpaces.cuda_threadidx() ÷ 2) % 4) * 8) + (IndexSpaces.cuda_warpidx() % 4) * 128) ÷ 2) % 256) + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 65536) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 32768) + 1i32)
        (A_beam0_cplx0_dish24, A_beam0_cplx1_dish24, A_beam0_cplx0_dish28, A_beam0_cplx1_dish28) = IndexSpaces.unsafe_load4_global(A_memory, ((((((((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 16 + ((IndexSpaces.cuda_threadidx() ÷ 8) % 4) * 2) + 1) % 128) * 256 + (((((IndexSpaces.cuda_threadidx() % 2) * 32 + ((IndexSpaces.cuda_threadidx() ÷ 2) % 4) * 8) + (IndexSpaces.cuda_warpidx() % 4) * 128) + 64) ÷ 2) % 256) + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 65536) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 32768) + 1i32)
        ...
        for T1 = 0:128:32767
            ...
            for T2 = 0:32:127
                let
                    (E_dish0, E_dish4, E_dish8, E_dish12) = IndexSpaces.unsafe_load4_global(E_memory, ((((((IndexSpaces.cuda_threadidx() % 8) * 16 + (IndexSpaces.cuda_warpidx() % 4) * 128) ÷ 4) % 128 + (((((IndexSpaces.cuda_threadidx() ÷ 8) % 4 + ((T1 ÷ 128) % 256) * 128) + ((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 4) + ((T2 ÷ 32) % 4) * 32) % 32768) * 10752) + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 128) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 5376) + 1i32)
                    E_shared[((((IndexSpaces.cuda_threadidx() % 8) * 16 + (IndexSpaces.cuda_warpidx() % 4) * 128) ÷ 4) % 128 + (((((IndexSpaces.cuda_threadidx() ÷ 8) % 4 + ((T1 ÷ 128) % 256) * 128) + ((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 4) + ((T2 ÷ 32) % 4) * 32) % 32) * 129) + 0x01] = E_dish0
                    E_shared[(((((IndexSpaces.cuda_threadidx() % 8) * 16 + (IndexSpaces.cuda_warpidx() % 4) * 128) + 4) ÷ 4) % 128 + (((((IndexSpaces.cuda_threadidx() ÷ 8) % 4 + ((T1 ÷ 128) % 256) * 128) + ((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 4) + ((T2 ÷ 32) % 4) * 32) % 32) * 129) + 0x01] = E_dish4
                    E_shared[(((((IndexSpaces.cuda_threadidx() % 8) * 16 + (IndexSpaces.cuda_warpidx() % 4) * 128) + 8) ÷ 4) % 128 + (((((IndexSpaces.cuda_threadidx() ÷ 8) % 4 + ((T1 ÷ 128) % 256) * 128) + ((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 4) + ((T2 ÷ 32) % 4) * 32) % 32) * 129) + 0x01] = E_dish8
                    E_shared[(((((IndexSpaces.cuda_threadidx() % 8) * 16 + (IndexSpaces.cuda_warpidx() % 4) * 128) + 12) ÷ 4) % 128 + (((((IndexSpaces.cuda_threadidx() ÷ 8) % 4 + ((T1 ÷ 128) % 256) * 128) + ((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 4) + ((T2 ÷ 32) % 4) * 32) % 32) * 129) + 0x01] = E_dish12
                end
                ...
                for T3 = 0:8:31
                    let
                        ...
                        let
                            ...
                            Aim = AselBD_cplx0
                            Are = AselBD_cplx1
                            E0 = E_shared[(((((IndexSpaces.cuda_threadidx() % 4) * 32 + ((D ÷ 4) % 8) * 4) + (IndexSpaces.cuda_warpidx() % 4) * 128) ÷ 4) % 128 + ((((((T3 ÷ 8) % 4) * 8 + (IndexSpaces.cuda_threadidx() ÷ 4) % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 129) + 0x01]
                        ...
                        Ju_shared[((((((IndexSpaces.cuda_warpidx() % 4) * 128) ÷ 128) % 4) * 4224 + ((((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 16 + ((B ÷ 8) % 2) * 8) + (IndexSpaces.cuda_threadidx() ÷ 4) % 8) % 128) + ((((((T3 ÷ 8) % 4) * 8 + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) + (IndexSpaces.cuda_threadidx() % 4) * 2) % 32) * 132) + 0x01] = Ju_time0
                        Ju_shared[((((((IndexSpaces.cuda_warpidx() % 4) * 128) ÷ 128) % 4) * 4224 + ((((IndexSpaces.cuda_warpidx() ÷ 4) % 8) * 16 + ((B ÷ 8) % 2) * 8) + (IndexSpaces.cuda_threadidx() ÷ 4) % 8) % 128) + (((((((T3 ÷ 8) % 4) * 8 + ((T1 ÷ 128) % 256) * 128) + 1) + ((T2 ÷ 32) % 4) * 32) + (IndexSpaces.cuda_threadidx() % 4) * 2) % 32) * 132) + 0x01] = Ju_time1
                    end
                    let
                        B = 8
                        AselB_cplx0_dish0 = zero(Int8x4)
                ...
                IndexSpaces.cuda_sync_threads()
                Ju_dish0_time0 = Ju_shared[(((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128 + (((IndexSpaces.cuda_threadidx() % 8 + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish128_time0 = Ju_shared[((4224 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + (((IndexSpaces.cuda_threadidx() % 8 + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish256_time0 = Ju_shared[((8448 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + (((IndexSpaces.cuda_threadidx() % 8 + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish384_time0 = Ju_shared[((12672 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + (((IndexSpaces.cuda_threadidx() % 8 + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish0_time8 = Ju_shared[(((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128 + ((((8 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish128_time8 = Ju_shared[((4224 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + ((((8 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish256_time8 = Ju_shared[((8448 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + ((((8 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish384_time8 = Ju_shared[((12672 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + ((((8 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish0_time16 = Ju_shared[(((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128 + ((((16 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish128_time16 = Ju_shared[((4224 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + ((((16 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish256_time16 = Ju_shared[((8448 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + ((((16 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish384_time16 = Ju_shared[((12672 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + ((((16 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish0_time24 = Ju_shared[(((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128 + ((((24 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish128_time24 = Ju_shared[((4224 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + ((((24 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish256_time24 = Ju_shared[((8448 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + ((((24 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
                Ju_dish384_time24 = Ju_shared[((12672 + ((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) + ((((24 + IndexSpaces.cuda_threadidx() % 8) + ((T1 ÷ 128) % 256) * 128) + ((T2 ÷ 32) % 4) * 32) % 32) * 132) + 0x01]
            ...
            IndexSpaces.unsafe_store4_global!(J_memory, ((((((((IndexSpaces.cuda_threadidx() % 2) * 16 + ((IndexSpaces.cuda_threadidx() ÷ 2) % 2) * 64) + ((T1 ÷ 128) % 256) * 128) + ((IndexSpaces.cuda_threadidx() ÷ 4) % 2) * 32) ÷ 4) % 8192 + (((IndexSpaces.cuda_warpidx() % 32) * 4 + (IndexSpaces.cuda_threadidx() ÷ 8) % 4) % 128) * 688128) + (((IndexSpaces.cuda_blockidx() ÷ 2) % 42) % 42) * 16384) + ((IndexSpaces.cuda_blockidx() % 2) % 2) * 8192) + 0x01, (Jper_time0, Jper_time32, Jper_time64, Jper_time96))
        end
    end
