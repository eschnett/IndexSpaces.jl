@inbounds begin #= /home/eschnett/src/jl/IndexSpaces/kernels/bb.jl:761 =#
    info = 1
    info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 32) % 32) * 768) + 0 + 0x01] =
        info
    s = s_memory[((((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 2) % 2) * 96 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) ÷ 2) % 16) % 16) * 192) + 0x01]
    s = s - 3
    if !(0 < s < 32)
        info = 2
        info_memory[(((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 32) % 32 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) % 24) * 32) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_blockidx(), 0, 32) % 32) % 32) * 768) + 0 + 0x01] =
        ...
        (
            (
                (
                    ...
                    (
                        (
                            (8 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) +
                            ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2
                        ) % 96
                    ) * 256
                ) +
        ...
        (
            (
                (
                    ...
                    (
                        (
                            (1 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) +
                            ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2
                        ) % 96
                    ) * 256
                ) +
        ...
        (
            (
                (
                    ...
                    (
                        (
                            (9 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) +
                            ((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) * 2
                        ) % 96
                    ) * 256
                ) +
    ...
    for T1 in 0:128:32767
        ...
        for T2 in 0:32:127
            if IndexSpaces.cuda_warpidx() < 16
                ...
                E_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0 + 0x01] =
                    E_dish0_time0
                E_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129 + (((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0 + 0x01] =
                    E_dish4_time0
                E_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129 + (((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0 + 0x01] =
                    E_dish8_time0
                E_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129 + (((12 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0 + 0x01] =
                    E_dish12_time0
                E_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129 + (((IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0 + 0x01] =
                    E_dish0_time16
                E_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129 + (((4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0 + 0x01] =
                    E_dish4_time16
                E_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129 + (((8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0 + 0x01] =
                    E_dish8_time16
                E_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 4) * 4) + 16) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129 + (((12 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) * 16) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0 + 0x01] =
                    E_dish12_time16
            end
            ...
            for T3 in 0:8:31
                let
                    ...
                    let
                        ...
                        Aim = AselBD_cplx0
                        Are = AselBD_cplx1
                        E0 = E_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 129 + (((((IndexSpaces.assume_inrange(D, 0, 4, 32) ÷ 4) % 8) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 32) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 4) % 128) + 0x01]
                    ...
                    Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((((IndexSpaces.assume_inrange(B, 0, 8, 16) ÷ 8) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) % 96) + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0 + 0x01] =
                        Ju_time0
                    Ju_shared[(((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 1) + ((IndexSpaces.assume_inrange(T3, 0, 8, 32) ÷ 8) % 4) * 8) + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 4) * 2) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((((IndexSpaces.assume_inrange(B, 0, 8, 16) ÷ 8) % 2) * 8 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 4) % 8) + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) ÷ 4) % 6) * 16) % 96) + ((((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 4) * 128) ÷ 128) % 4) * 3200) + 0 + 0x01] =
                        Ju_time1
                end
                let
                    B = 8
            ...
            IndexSpaces.cuda_sync_threads()
            Ju_dish0_time0 = Ju_shared[((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 0x01]
            Ju_dish128_time0 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 3200) + 0x01]
            Ju_dish256_time0 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 6400) + 0x01]
            Ju_dish384_time0 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 9600) + 0x01]
            Ju_dish0_time8 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 8) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 0x01]
            Ju_dish128_time8 = Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 8) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 3200) + 0x01]
            Ju_dish256_time8 = Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 8) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 6400) + 0x01]
            Ju_dish384_time8 = Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 8) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 9600) + 0x01]
            Ju_dish0_time16 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 16) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 0x01]
            Ju_dish128_time16 = Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 16) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 3200) + 0x01]
            Ju_dish256_time16 = Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 16) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 6400) + 0x01]
            Ju_dish384_time16 = Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 16) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 9600) + 0x01]
            Ju_dish0_time24 = Ju_shared[(((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 24) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 0x01]
            Ju_dish128_time24 = Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 24) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 3200) + 0x01]
            Ju_dish256_time24 = Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 24) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 6400) + 0x01]
            Ju_dish384_time24 = Ju_shared[((((((((IndexSpaces.assume_inrange(T2, 0, 32, 128) ÷ 32) % 4) * 32 + 24) + IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) % 8) + ((IndexSpaces.assume_inrange(T1, 0, 128, 32768) ÷ 128) % 256) * 128) % 32) * 100 + ((IndexSpaces.assume_inrange(IndexSpaces.cuda_warpidx(), 0, 24) % 24) * 4 + (IndexSpaces.assume_inrange(IndexSpaces.cuda_threadidx(), 0, 32) ÷ 8) % 4) % 96) + 9600) + 0x01]
