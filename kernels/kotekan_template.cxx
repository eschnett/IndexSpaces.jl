...
private:
    ...
    static constexpr int cuda_number_of_beams = {{B}};
    static constexpr int cuda_number_of_complex_components = {{C}};
    static constexpr int cuda_number_of_dishes = {{D}};
    static constexpr int cuda_number_of_frequencies = {{F}};
    static constexpr int cuda_number_of_polarizations = {{P}};
    static constexpr int cuda_number_of_timesamples = {{T}};
    static constexpr double cuda_sampling_time_usec = {{sampling_time_μsec}};
    static constexpr int cuda_shift_parameter_sigma = {{σ}};
    ...
    // Kernel name
    const char* const kernel_name = "{{kernel_name}}";

    // Kernel arguments
    static constexpr std::size_t A_length = {{A_length}};
    static constexpr std::size_t E_length = {{E_length}};
    static constexpr std::size_t s_length = {{s_length}};
    static constexpr std::size_t J_length = {{J_length}};
    static constexpr std::size_t info_length = {{info_length}};
